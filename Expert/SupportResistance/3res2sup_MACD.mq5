...
void findSupportResistance()
  {
   ...
   CopyBuffer(macdHandle,MAIN_LINE,1,100,macdValues);
   ...
   if(OrdersTotal()<1)
     {
      ...
      if((Support1<Support2 && Support2<Support3) && (Resistance1<Resistance2) && (macdValues[98-Support1Index]>macdValues[98-Support2Index]))
        {
      ...
      else if((Resistance1>Resistance2 && Resistance2>Resistance3) && (Support1>Support2) && (macdValues[98-Resistance1Index]<macdValues[98-Resistance2Index]))
        {
         MqlTradeRequest request1={0};
         MqlTradeResult result1={0};
         request1.symbol = Symbol();
