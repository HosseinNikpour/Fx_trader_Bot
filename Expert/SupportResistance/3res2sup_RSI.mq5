...
void findSupportResistance()
  {
   ...
   CopyBuffer(RSIHandle,MAIN_LINE,1,100,rsiValues);
   ...
   if(OrdersTotal()<1)
     {
      ...
      if((Support1<Support2 && Support2<Support3) && (Resistance1<Resistance2) && (rsiValues[98-Support1Index]>rsiValues[98-Support2Index]))
        {
      ...
      else if((Resistance1>Resistance2 && Resistance2>Resistance3) && (Support1>Support2) && (rsiValues[98-Resistance1Index]<rsiValues[98-Resistance2Index]))
        {
         MqlTradeRequest request1={0};
         MqlTradeResult result1={0};
         request1.symbol = Symbol();
