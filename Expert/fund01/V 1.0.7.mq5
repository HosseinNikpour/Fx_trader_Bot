...
input long maxTimeToClose=86400;                  
//+------------------------------------------------------------------+
...
void OnTick()
  {
   ...
   OpenPosition( "AUDCAD","AUDUSD","USDCAD",0.0009, 0.0015,0.02,5,0);
   OpenPosition( "NZDCAD","NZDUSD","USDCAD",0.0002, 0.0015,0.02,5,1);
   OpenPosition( "NZDCHF","NZDUSD","USDCHF",0.0002, 0.0015,0.02,7,2);
     // v 1.4
      ...
      if(PositionSelect(mainPair))
        {
         ...
         if(pos_type!=last_pos_type[pairIndex]||x>(maxTimeToClose*1000))
           {
            CTrade trade;
